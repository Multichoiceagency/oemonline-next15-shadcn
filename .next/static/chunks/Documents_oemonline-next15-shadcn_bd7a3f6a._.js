...
"[project]/Documents/oemonline-next15-shadcn/app/dashboard/catalog/plate/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    async function run() {
        ...
        setErr(null);
        try {
            const res = await fetch("/api/plates?plate=".concat(encodeURIComponent(plate), "&country=nl"));
            const j = await res.json();
            if (!res.ok) throw new Error((j === null || j === void 0 ? void 0 : j.error) || "Plate request failed");
            setData(j);
        } catch (e) {
            setErr(e.message);
        } finally{
...
_s(Page, "iCmki8/BiTZCAcXPdEse/8C8i/s=");
_c = Page;
var _c;
...
//# sourceMappingURL=Documents_oemonline-next15-shadcn_bd7a3f6a._.js.map