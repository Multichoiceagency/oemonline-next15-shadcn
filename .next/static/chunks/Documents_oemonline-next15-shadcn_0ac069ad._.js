...
"[project]/Documents/oemonline-next15-shadcn/app/catalog/search/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Page() {
    ...
    async function run() {
        if (!q) return;
        const res = await fetch("/api/search?q=".concat(encodeURIComponent(q)));
        const data = await res.json();
        var _data_results, _ref;
        setRows((_ref = (_data_results = data === null || data === void 0 ? void 0 : data.results) !== null && _data_results !== void 0 ? _data_results : data === null || data === void 0 ? void 0 : data.articles) !== null && _ref !== void 0 ? _ref : []); // afhankelijk van op
    }
...
_s(Page, "L6g/zvSfWtUEhLeICTROaLpm2W0=");
_c = Page;
var _c;
...
//# sourceMappingURL=Documents_oemonline-next15-shadcn_0ac069ad._.js.map